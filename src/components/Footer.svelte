      ...
      <a href="https://facebook.com/syndicateofamity46" target="_blank">
        <div class="link">
          <svg
            ...
            width="15.833"
            height="28.365"
            viewBox="0 0 15.833 28.365"
          >
            <path
              id="Icon_awesome-facebook-f"
              data-name="Icon awesome-facebook-f"
              d="M16.405,15.955l.821-5.133H12.093V7.491c0-1.4.717-2.773,3.016-2.773h2.334V.347A29.626,29.626,0,0,0,13.3,0C9.072,0,6.309,2.459,6.309,6.91v3.912h-4.7v5.133h4.7v12.41h5.784V15.955Z"
      ...
      <a href="mailto:cyberamity46@gmail.com">
        <div class="link">
          <svg
            ...
            width="36.75"
            height="25.443"
            viewBox="0 0 36.75 25.443"
          >
            <g
              id="Group_162"
              data-name="Group 162"
              transform="translate(-989.125 -1981.096)"
            >
              <path
                id="Path_31"
                data-name="Path 31"
                d="M39.825,10.368,30.319,20.05a.171.171,0,0,0,0,.247l6.652,7.085a1.146,1.146,0,0,1,0,1.625,1.152,1.152,0,0,1-1.625,0L28.72,21.95a.181.181,0,0,0-.256,0l-1.617,1.643a7.113,7.113,0,0,1-5.071,2.138,7.256,7.256,0,0,1-5.177-2.2L15.045,21.95a.181.181,0,0,0-.256,0L8.163,29.008a1.152,1.152,0,0,1-1.625,0,1.146,1.146,0,0,1,0-1.625L13.19,20.3a.188.188,0,0,0,0-.247L3.675,10.368a.174.174,0,0,0-.3.124V29.865A2.835,2.835,0,0,0,6.2,32.692H37.3a2.835,2.835,0,0,0,2.827-2.827V10.492A.177.177,0,0,0,39.825,10.368Z"
                transform="translate(985.75 1973.847)"
              />
              <path
                id="Path_32"
                data-name="Path 32"
                d="M21.532,24.05A4.8,4.8,0,0,0,24.986,22.6L38.847,8.493A2.776,2.776,0,0,0,37.1,7.875H5.975a2.758,2.758,0,0,0-1.749.618L18.087,22.6A4.8,4.8,0,0,0,21.532,24.05Z"
                transform="translate(985.968 1973.221)"
              />
            </g>
          </svg>
        </div>
